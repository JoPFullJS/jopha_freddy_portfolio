...
if(isset($_GET['domaine'])){
	...
	if($count_domaine_fetch['domaine'] == 1){
		...
		/*on selectionne les travaux qui appartiennent au domaine Back end*/
		...
		/*on selectionne les categorie qui appartiennent au doamine Back end*/
	...
	<div class="list-sub-menu visible-lg visible-md visible-sm">
		<nav class="navigation menu-blog margin-left-130">
			<ul>
				...
				<li class="group-desktop ele_list blue-10 selection"><a href="<?= WEBROOT; ?>travaux/back-end/" title="Back End" class="grey blue-10 lh-30-pg-30 deco link_list">Back End</a></li>
		...
		<div class="list-travaux">
			...
			<div class="info-user">
				<div class="image">
					...
					<a href="<?= WEBROOT; ?>travaux/back-end/<?= $domaine['categorie']; ?>/<?= $domaine['article']; ?>/" title="<?= $domaine['nom']; ?>" class="info-generales">
			...
			<header class="titre-travaux">
				<p>
					<a href="<?= WEBROOT; ?>travaux/back-end/<?= $domaine['categorie']; ?>/<?= $domaine['article']; ?>/" title="<?= $domaine['titre']; ?>"><?= $domaine['titre']; ?></a>
				</p>
			</header>
