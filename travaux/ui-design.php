...
if(isset($_GET['domaine'])){
	...
	if($count_domaine_fetch['domaine'] == 1){
		...
		/*on selectionne les travaux qui appartiennent au domaine UI design*/
		...
		/*on selectionne les categorie qui appartiennent au doamine UI design*/
	...
	/*on fait une redirection sur la page par defaut de front end : html-css*/
}
?>
<!DOCTYPE html>
<html lang="fr">
...
<section id="conteneur">
	...
	<div class="list-sub-menu visible-lg visible-md visible-sm">
		<nav class="navigation menu-blog margin-left-130">
			<ul>
				<li class="group-desktop ele_list blue-10"><a href="<?= WEBROOT; ?>travaux/front-end/" title="front End" class="grey blue-10 lh-30-pg-30 deco link_list">Front End</a></li>
				...
				<li class="group-desktop ele_list blue-10 selection"><a href="<?= WEBROOT; ?>travaux/ui-design/" title="UI Design" class="grey blue-10 lh-30-pg-30 deco link_list">UI Design</a></li>
			</ul>
		</nav>	
	</div>
		...
		<div class="list-travaux">
			...
			<div class="info-user">
				<div class="image">
					...
					<a href="<?= WEBROOT; ?>travaux/ui-design/<?= $domaine['categorie']; ?>/<?= $domaine['article']; ?>/" title="<?= $domaine['nom']; ?>" class="info-generales">
			...
			<header class="titre-travaux">
				<p>
					<a href="<?= WEBROOT; ?>travaux/ui-design/<?= $domaine['categorie']; ?>/<?= $domaine['article']; ?>/" title="<?= $domaine['titre']; ?>"><?= $domaine['titre']; ?></a>
				</p>
			</header>
