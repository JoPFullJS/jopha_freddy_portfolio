...
if(isset($_POST['id']) && isset($_POST['competences']) && isset($_POST['slug']) &&isset($_POST['categorie']) && isset($_POST['taux']) && isset($_POST['technique_key']) && isset($_POST['travaux_key']) && isset($_POST['titre']) && isset($_POST['description'])){
  ...
  if(isset($_GET['titre']))
  {
    ...
    $update_competences = $connect->prepare("
    	    UPDATE competences 
	...
	$update_competences->bindValue('categorie', $categorie, PDO::PARAM_INT);
	$update_competences->bindValue('competence', $competences, PDO::PARAM_STR);
	$update_competences->bindValue('slug', $slug, PDO::PARAM_STR);
	$update_competences->bindValue('taux', $taux, PDO::PARAM_INT);
	$update_competences->bindValue('technique', $technique_key, PDO::PARAM_INT);
	$update_competences->bindValue('travaux', $travaux_key, PDO::PARAM_INT);
	$update_competences->bindValue('titre', $titre, PDO::PARAM_STR);
	$update_competences->bindValue('description', $description, PDO::PARAM_STR);
	$update_competences->bindValue('id', $id, PDO::PARAM_STR);

	$update_competences->execute();

    if($update_competences->execute()){
...
if(isset($_GET['titre'])){
	...
	$competences->bindValue('titre', $_GET['titre'], PDO::PARAM_STR).
...
<head>
	...
	<title>update competences</title>
		...
		<div class="form-content">
			<form id="contact" method="post" action="#"  enctype="multipart/form-data">
				<div class="form-style">
						<label>ID :</label>
						<input type="text" name="id" value="<?= html_entity_decode($competences_fetch['id_competences']); ?>">
				</div>
				<div class="form-style">
						<label>categorie (Front =1, back=2, UI design=3) :</label>
						<input type="text" name="categorie" value="<?= $competences_fetch['id_cat_compet']; ?>">
				</div>
				<div class="form-style">
						<label>Competences :</label>
						<input type="text" name="competences" value="<?= $competences_fetch['nom']; ?>" >
				</div>
				<div class="form-style">
						<label>Slug :</label>
						<input type="text" name="slug" value="<?= $competences_fetch['slug']; ?>">
				</div>
				<div class="form-style">
						<label>Taux :</label>
						<input type="text" name="taux" value="<?= $competences_fetch['taux']; ?>">
				</div>
				<div class="form-style">
						<label>Technique_key :</label>
						<input type="text" name="technique_key" value="<?= $competences_fetch['technique_key']; ?>">
				</div>
				<div class="form-style">
						<label>Travaux_key :</label>
						<input type="text" name="travaux_key" value="<?= $competences_fetch['travaux_key']; ?>">
				</div>
				<div class="form-style">
						<label>Titre :</label>
						<input type="text" name="titre" value="<?= $competences_fetch['titre']; ?>">
				</div>
				<div class="form-style">
						<label>Description :</label>
						<input type="text" name="description" value="<?= $competences_fetch['description']; ?>">
				</div>
				<div class="form-submit">
				<!-- on mettra les info de soumissiona ce niveau pour les requetes ajax -->
					<input class="sub_rn" type="submit" name="envoyer" value="Update <?= $competences_fetch['nom']; ?>" >
				</div>
			</form>
		</div>
	</section>
