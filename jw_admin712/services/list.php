...
<head>
	...
	<title>Liste de mes services</title>
...
<body>
	...
	<div class="insert_element">
		<a href="<?= WEBROOT; ?>jw_admin712/services/insert/new/">insérer un service</a>
	</div>
		...
		<article class="intitule-services table">
			<header>
				<div class="img-poste-dev">
					<img src="<?= WEBROOT; ?>img/services/<?= $service['slug']; ?>.png" alt="Développeur Front End">
				</div>
				<h4><?= html_entity_decode($service['nom']); ?></h4>
			</header>
			<p><?= html_entity_decode($service['description']); ?></p>
			<div class="update">
				<a href="<?= WEBROOT; ?>jw_admin712/services/<?= $service['slug']; ?>/" title="Mettre à jour">Mettre à jour</a>
			</div>
			<div class="delete">
				<a href="<?= WEBROOT; ?>jw_admin712/services/delete/<?= $service['id_service']; ?>/" title="supprimer">supprimer</a>
			</div>
		</article>
		<?php endforeach; ?>
